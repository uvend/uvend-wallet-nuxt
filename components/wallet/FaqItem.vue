<template>
    <div 
        ...
        :class="{
            'ring-2 ring-blue-500/20 shadow-md': isOpen,
            'hover:border-blue-300/60': !isOpen
        }"
    >
        <!-- Gradient accent on hover -->
        <div class="absolute inset-0 bg-gradient-to-r from-blue-50/0 via-blue-50/0 to-blue-50/0 group-hover:from-blue-50/50 group-hover:via-blue-50/30 group-hover:to-blue-50/0 transition-all duration-300 pointer-events-none"></div>
        
        <button
            @click="toggle"
            class="relative w-full flex items-start justify-between py-5 px-6 text-left transition-all duration-200"
            :class="{
                'bg-gradient-to-r from-blue-50/50 to-transparent': isOpen
            }"
        >
            <div class="flex items-start gap-4 flex-1 pr-4">
                ...
                <div 
                    ...
                    :class="{
                        'bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-md': isOpen,
            ...
            <div 
                ...
                :class="{
                    'bg-blue-100 text-blue-600 rotate-180': isOpen,
        ...
        >
            ...
            >
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 pl-4 border-l-2 border-blue-200/60 space-y-2">
