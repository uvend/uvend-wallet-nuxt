<template>
    ...
    <Card v-if="passwordResetComplete" class="w-[450px] max-w-[90vw] bg-white/95 backdrop-blur-sm border-0 shadow-2xl overflow-hidden">
        <div class="bg-gradient-to-r from-green-600 via-green-700 to-green-800 px-4 py-4 text-white relative overflow-hidden">
            ...
            <div class="relative z-10 text-center">
                <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3 backdrop-blur-sm">
                    <Icon name="lucide:check-circle" class="h-6 w-6 text-white"/>
                </div>
                <h1 class="text-xl font-bold mb-1">Password Reset Successful!</h1>
                <p class="text-sm text-white/90">Your password has been updated</p>
            </div>
        </div>
        <CardFooter class="p-4">
            <Button 
                class="w-full h-10 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold shadow-lg shadow-green-500/30 transition-all duration-200" 
